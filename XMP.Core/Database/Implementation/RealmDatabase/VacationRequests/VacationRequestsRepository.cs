...
namespace XMP.Core.Database.Implementation.RealmDatabase
{
    ...
    {
        public VacationRequestsRepository(IRealmRepositoryEntriesMapper<VacantionRequest, VacationRequestRealmObject> realmRepositoryEntriesMapper, IRealmProvider realmProvider) : base(item => item.LocalId, realmRepositoryEntriesMapper, realmProvider)
        {
        }
    }
}
